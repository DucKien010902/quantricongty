    ...
    <div className="space-y-6 animate-fade-in relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-purple-200/90 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-sm font-semibold text-slate-600">Lượt dập thẻ thô</span>
      ...
      <div className="flex items-center justify-between border-b border-slate-200 bg-white px-3 pt-2 rounded-2xl border">
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span>3. Nhật ký dập thẻ gốc</span>
            <span className="px-2 py-0.5 rounded-full bg-slate-100 text-[11px] font-mono font-bold text-slate-600">
              {rawTotal}
            </span>
          </button>
              ...
              <table className="w-full text-left border-collapse text-xs">
                <thead className="bg-slate-50 text-slate-600 border-b border-slate-200 font-bold tracking-wider text-xs">
                  <tr>
                    ...
                    <th className="py-3.5 px-3 text-center">Giờ vào</th>
                    <th className="py-3.5 px-3 text-center">Giờ ra</th>
                    <th className="py-3.5 px-3 text-center min-w-[95px]">Giờ làm</th>
                    <th className="py-3.5 px-3 text-center">Thiếu phút</th>
                    <th className="py-3.5 px-4">Trạng thái đánh giá</th>
                    <th className="py-3.5 px-3 text-center">Công</th>
                    ...
                    filteredDailyData.map((row: any, idx: number) => (
                      <tr key={idx} className="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td className="py-4 px-4 min-w-[200px]">
                          <div>
                            <p className="font-bold text-slate-900 text-sm leading-snug">{row.name}</p>
                        ...
                        <td className="py-4 px-4 text-slate-700 font-medium">
                          {row.department || "Chung"}
                        </td>

                        {/* Date & Weekday */}
                        <td className="py-4 px-4">
                          <span className="font-bold text-slate-800 text-xs">{row.date}</span>
                          <span className="text-xs text-slate-400 font-medium ml-1.5">({row.weekday})</span>
                        </td>

                        {/* In */}
                        <td className="py-4 px-3 text-center font-mono font-bold text-slate-800 text-xs">
                          {row.firstIn ? (
                        ...
                        {/* Work Hours */}
                        <td className="py-4 px-3 text-center font-mono font-bold text-slate-800 whitespace-nowrap text-xs">
                          <span className="px-2.5 py-1 rounded-lg bg-slate-100 text-slate-900 font-semibold">
                            {formatWorkTime(row)}
                          </span>
                        </td>
                        ...
                        <td className="py-4 px-3 text-center font-mono text-xs">
                          {row.missingMinutes > 0 ? (
                            <span className="text-amber-600 font-bold">-{row.missingMinutes}p</span>
                          ) : (
                            <span className="text-emerald-600 font-semibold">0p</span>
                          )}
                        </td>
                        ...
                        <td className="py-4 px-3 text-center font-bold font-mono">
                          <span
                            className={
                              row.workCredit > 0 ? "text-emerald-600 font-extrabold text-sm" : "text-slate-400 text-xs"
                            }
                          >
                            {row.workCredit ? row.workCredit.toFixed(1) : "0.0"}
                          </span>
                        </td>

                        {/* Note */}
                        <td className="py-4 px-3 text-xs text-slate-500 max-w-[120px] truncate text-center font-medium" title={row.note || "--"}>
                          {row.note || "--"}
                        </td>
                      </tr>
                    ))
      ...
      {/* ========================================================================= */}
      {/* TAB 3: NHẬT KÝ DẬP THẺ GỐC (RAW LOGS) */}
      {/* ========================================================================= */}
      {activeTab === "raw" && (
        <div className="space-y-4">
          <div className="bg-white rounded-2xl border border-slate-200/90 shadow-xs overflow-hidden">
              ...
              <table className="w-full text-left border-collapse text-xs">
                <thead className="bg-slate-50 text-slate-600 border-b border-slate-200 font-bold tracking-wider text-xs">
                  <tr>
                    ...
                    <th className="py-3.5 px-4">Thời điểm dập (Timestamp)</th>
                  ...
                  {rawLogs.length === 0 ? (
                    <tr>
                      <td colSpan={8} className="py-12 text-center text-slate-500">
                        Chưa có bản ghi nhật ký thô nào.
                      </td>
                    </tr>
                  ) : (
